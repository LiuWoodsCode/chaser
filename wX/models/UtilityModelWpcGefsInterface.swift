...
final class UtilityModelWpcGefsInterface {
    ...
    static let titles = [
        MenuTitle("Precip", 37),
        MenuTitle("QPF > Annual Chance (CONUS only)", 8),
        MenuTitle("Precip Type", 4),
        MenuTitle("Stnd Anom Hght", 16),
        MenuTitle("2m Tmps", 21),
        MenuTitle("Upper Level Temps", 10),
        MenuTitle("Stnd Anom Temps", 18),
        MenuTitle("Other", 43)
    ]
