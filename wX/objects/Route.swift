...
final class Route {
    ...
    static func goes(_ uiv: UIViewController) {
        vis(uiv)
    }
    ...
    static func nhcStorm(_ uiv: UIViewController, _ storm: NhcStormDetails) {
        let vc = VcNhcStorm()
        vc.stormData = storm
        uiv.goToVC(vc)
    }
    ...
    static func radar(_ uiv: UIViewController, _ numberOfPanes: Int) {
        let vc = VcNexradRadar()
        vc.numberOfPanes = numberOfPanes
        uiv.goToVC(vc)
    }
    ...
    static func radarFromTimeButton(_ uiv: UIViewController, _ numberOfPanes: Int) {
        let vc = VcNexradRadar()
        vc.numberOfPanes = numberOfPanes
        vc.calledFromTimeButton = true
    ...
    static func rtma(_ uiv: UIViewController, _ product: String) {
        let vc = VcRtma()
        vc.productCode = product
        uiv.goToVC(vc)
    }
    ...
    static func spcMesoBySector(_ uiv: UIViewController, _ sector: String) {
        let vc = VcSpcMeso()
        vc.sectorSpecified = true
        vc.sector = sector
        uiv.goToVC(vc)
    }

    static func spcSounding(_ uiv: UIViewController, _ site: String) {
        let vc = VcSoundings()
        vc.site = site
        uiv.goToVC(vc)
    }
    ...
    static func spottersUI(_ uiv: UIViewController) {
        let swiftUIViewController = UIHostingController(rootView: UISpotters())
        uiv.goToVC(swiftUIViewController)
    }
    ...
    static func visBySector(_ uiv: UIViewController, _ sector: String) {
        let vc = VcGoes()
        vc.productCode = "GEOCOLOR"
        vc.sectorCode = sector
        vc.savePrefs = false
        uiv.goToVC(vc)
    }
    ...
    static func wfoTextBySector(_ uiv: UIViewController, _ sector: String) {
        let vc = VcWfoText()
        vc.wfo = sector
        vc.sectorSpecified = true
        uiv.goToVC(vc)
    ...
    static func wpcTextNoSave(_ uiv: UIViewController, _ product: String) {
        let vc = VcWpcText()
        vc.wpcTextProduct = product
        vc.savePrefs = false
        uiv.goToVC(vc)
