...
final class NexradLevel2Util {

    private static let fileHeaderSize = 24

    static func decompress(_ radarBuffers: MetalRadarBuffers, _ fileStorage: FileStorage) {
        let destinationPath = radarBuffers.fileName + ".decomp" + radarBuffers.levelData.indexString
        let disFirst = fileStorage.memoryBufferL2
        disFirst.position = 0
        ...
        let loopCntBreak = radarBuffers.levelData.productCode == 153 ? 5 : 11
