...
final class NexradLevel3WindBarbs {

    static func decode(_ projectionNumbers: ProjectionNumbers, isGust: Bool, _ fileStorage: FileStorage) -> [Double] {
        var stormList = [Double]()
        let arrWb = !isGust ? fileStorage.obsArrWb : fileStorage.obsArrWbGust
        ...
        arrWb.forEach { windBarb in
            ...
            if length > 4 {
                ...
                var ec = ExternalGeodeticCalculator.calculateEndingGlobalCoordinates(start, degree, nm * nmScaleFactor * barbLengthScaleFactor)
                ...
                if above50 {
                    ...
                    stormList += NexradLevel3Common.drawLine(ec, projectionNumbers, degree2 - 90.0, startLength + 0.80 * arrowLength * nmScaleFactor)
                    ...
                    stormList += NexradLevel3Common.drawLine(ec, projectionNumbers, degree2 - 180.0, startLength + 0.5 * arrowLength * nmScaleFactor)
                    index += 1
                }
