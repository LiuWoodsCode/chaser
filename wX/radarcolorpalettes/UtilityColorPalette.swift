...
final class UtilityColorPalette {
    ...
    static func getColorMapStringFromDisk(_ product: Int, _ code: String) -> String {
        ...
        case 94:
            ...
            case "CUST":
                cmFileInt = R.Raw.colormaprefcode
            case "CODE":
                cmFileInt = R.Raw.colormaprefcode
            case "NSSL":
                cmFileInt = R.Raw.colormaprefnssl
            case "NWSD":
                cmFileInt = R.Raw.colormaprefnwsd
            case "NWS":
                cmFileInt = R.Raw.colormaprefnws
            case "COD":
                cmFileInt = R.Raw.colormaprefcodenh
            case "CODENH":
                cmFileInt = R.Raw.colormaprefcodenh
            case "MENH":
                cmFileInt = R.Raw.colormaprefmenh
            case "GREEN":
                cmFileInt = R.Raw.colormaprefgreen
            case "AF":
                cmFileInt = R.Raw.colormaprefaf
            case "EAK":
