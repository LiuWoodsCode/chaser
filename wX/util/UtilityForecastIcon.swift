...
final class UtilityForecastIcon {
    ...
    static func getIcon(_ url: String) -> Bitmap {
        ...
        if UtilityNwsIcon.iconMap[fileName + ".png"] != nil {
    ...
    static private func getDualBitmapWithNumbers(_ iconLeftString: String, _ iconRightString: String) -> Bitmap {
        ...
        // legacy add end
        let forecastIcon = ForecastIcon(leftWeatherCondition, rightWeatherCondition)
        forecastIcon.drawLeftText(leftNumber, rightNumber)
    ...
    static private func getBitmapWithOneNumber(_ iconString: String) -> Bitmap {
        ...
        // legacy add end
        let forecastIcon = ForecastIcon(weatherCondition)
        forecastIcon.drawSingleText(number)
        return forecastIcon.get()
    }

    static private func getFilename(_ url: String) -> String {
