...
final class UtilityWpcImages {
    ...
    static let urls = [
        ...
        GlobalVariables.nwsWPCwebsitePrefix + "/lowclusters/lowclusters_latest.png",
        ...
        "https://apps.glerl.noaa.gov/coastwatch/webdata/glsea/cur/glsea_cur.png",
        ...
        GlobalVariables.nwsCPCNcepWebsitePrefix + "/products/predictions/short_range/HI/610temp.HI.wide.gif",
        GlobalVariables.nwsCPCNcepWebsitePrefix + "/products/predictions/short_range/HI/610prcp.HI.wide.gif",
        GlobalVariables.nwsCPCNcepWebsitePrefix + "/products/predictions/short_range/HI/814temp.HI.wide.gif",
        GlobalVariables.nwsCPCNcepWebsitePrefix + "/products/predictions/short_range/HI/814prcp.HI.wide.gif",
        ...
        GlobalVariables.nwsCPCNcepWebsitePrefix + "/products/precip/CWlink/ghaz/gth_full.png",

        GlobalVariables.nwsAWCwebsitePrefix + "/data/products/sigmet/sigmet_all.gif",
